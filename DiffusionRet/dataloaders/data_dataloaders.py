...
DATALOADER_DICT["msvd"] = {"train": dataloader_msvd_train, "val": None, "test": dataloader_msvd_test}
DATALOADER_DICT["lsmdc"] = {"train": dataloader_lsmdc_train, "val": None, "test": dataloader_lsmdc_test}