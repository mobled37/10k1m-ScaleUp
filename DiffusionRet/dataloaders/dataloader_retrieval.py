...
import DiffusionRet.dataloaders.video_transforms as video_transforms
...
class RetrievalDataset(Dataset):
    ...
    def _get_rawvideo(self, video_id, s=None, e=None):
        ...
        # T x 3 x H x W
        video = np.zeros((self.max_frames, 3, self.rawVideoExtractor.size, self.rawVideoExtractor.size), dtype=np.single)
